...
class TestTranformation(PySparkTestCase):
    def test_single_space(self):
        ...
        path = 'file:///Users/sapnagupta/Downloads/latest/test/it_data'

        # Apply the transformation function from before

        it_data(df1, df2,path)

        transformed_df =  spark.read.csv('/Users/sapnagupta/Downloads/latest/test/it_data/*.csv', inferSchema='true')

        expected_df = spark.read.csv('/Users/sapnagupta/Downloads/latest/test/expected_it_data/*.csv', inferSchema='true')
