...
class TestTranformation(PySparkTestCase):
    def test_single_space(self):
        ...
        path = 'file:///Users/sapnagupta/Downloads/latest/test/top_3_best_salesperson_department_country'

        # Apply the transformation function from before
        top_3_best_salesperson_department_country(df1,df2,df3,path)
        transformed_df = spark.read.csv('/Users/sapnagupta/Downloads/latest/test/top_3_best_salesperson_department_country/*.csv', inferSchema='true')
        expected_df = spark.read.csv('/Users/sapnagupta/Downloads/latest/test/expected_top_3_best_salesperson_department_country/*.csv', inferSchema='true')
