...
def run (spark, path):  
    ...
    path1 = 'file:///Users/sapnagupta/Downloads/latest/output/it_data'
    it_data(df1, df2, path1)
    path2 = 'file:///Users/sapnagupta/Downloads/latest/output/marketing_address_info'
    marketing_address_info(df1, df2,path2)   
    path3 = 'file:///Users/sapnagupta/Downloads/latest/output/department_breakdown'
    output3 = department_breakdown(df1, df2,path3)
    path4 =  'file:///Users/sapnagupta/Downloads/latest/output/top_3_best_performers_per_department'  
    top_3_best_performers_per_department(df1,df2,path4)
    path5 = 'file:///Users/sapnagupta/Downloads/latest/output/top_3_most_sold_per_department_netherlands'
    top_3_most_sold_products_per_department(df1,df3,path5)
    path6 = 'file:///Users/sapnagupta/Downloads/latest/output/best_salesperson'
    top_3_best_salesperson_department(df2,df3,path6)
    path7 = 'file:///Users/sapnagupta/Downloads/latest/output/best_salesperson_department'
